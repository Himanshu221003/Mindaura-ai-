...
// Initialize Groq API via OpenAI SDK
...
const sendMessage = async (req, res) => {
    try {
        ...
        try {
            ...
            logger_1.logger.error("Inngest error (ignoring):", inngestError);
        }
    ...
    Required JSON structure:
    {
      ...
      "progressIndicators": ["string"]
        ...
        try {
            ...
            logger_1.logger.error("JSON Parse Error:", parseError, "Raw Text:", cleanAnalysisText);
            analysis = {
    ...
    5. Considers safety and well-being`;
        ...
        const response = responseCompletion.choices[0]?.message?.content || "I am here for you.";

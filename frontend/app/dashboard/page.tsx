...
export default function Dashboard() {
  ...
  const fetchDailyStats = useCallback(async () => {
    try {
      ...
      // Fetch today's activities using static data
      const { getTodaysActivities } = await import("@/lib/static-dashboard-data");
      const activities = await getTodaysActivities("default-user");
